...
#	return_var	戻り値を設定する変数名
#	option_var	オプション変数名
#	source_dir	カレントソースディレクトリ名
#	default_dir	デフォルトディレクトリ名
#	file_name	パラメータファイル名	
#
function(read_params return_var option_var source_dir default_dir file_name)
    # 最初にオプション変数を調べる
    if(DEFINED ${option_var} and EXISTS ${option_var})
	set(${return_var} ${option_var})
    endif()
endfunction()
