...
Windows 7/8/10, Visual Studio 2015/2017では問題なく動作します．
...
\newcommand{\Rarrow}{\raisebox{1pt}{ $>$ }}
「Visual C++ Windows\Rarrow デスクトップ ウィザード」を作成します．
...
プロジェクトを作成したら
「プロジェクト\Rarrow 新しい項目の追加\Rarrow C++ファイル(.cpp)」
としてソースファイルを作成します．
