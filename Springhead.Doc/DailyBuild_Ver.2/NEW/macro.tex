...
\def\Vskip#1{\relax\ifvmode\vspace{#1}%
	\else\hbox{\\}\vbox{\vspace{-\baselineskip}{\vspace{#1}}}\fi}
\let\Hskip\hspace
...
\def\Cmnd#1#2{%
	\vbox{\vspace{.4\baselineskip}\CmndBox{#1}{#2}\vspace{0\baselineskip}}}
...
\if0
%% \begin{GeneralBase}{title}		%%%% obsoleted %%%%
%  \end{GeneralBase}
%
\def\GeneralBase#1{%
	\@ifnextchar[{\GeneralBase@check}{\begin{GeneralBox}{#1}}}
\def\GeneralBase@check[#1]{\@ifnextchar[{\GeneralBase@@[#1]}
	{\begin{GeneralBox}[#1][\WID]{#1}}}
\def\GeneralBase@@[#1][#2]{\begin{GeneralBox}[#1][#2]{#1}}
