% macro.tex
%	Last update: 2018/07/29 F.Kanehori
...
\def\Cmnd#1{%
	\vbox{\vspace{.4\baselineskip}\CmndBox{#1}\vspace{0\baselineskip}}}
...
\def\Table@@[#1][#2]#3{
	...
	\addtolength{\Table@desc@wid}{-18pt}
...
\let\MC\multicolumn
\def\Cell#1{\begingroup\tabcolsep=0pt \begin{tabular}[t]{l}#1\end{tabular}\endgroup}
