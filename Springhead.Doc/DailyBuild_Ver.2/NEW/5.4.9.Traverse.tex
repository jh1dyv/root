...
\begin{Initializer}{%
	...
	\begin{Args}[5em]
	    ...
	    \hline
	\end{Args}
	\small{\begin{Table}[t][25pt]{ll}
		\Item{\Hskip{25pt}\Dagger}{\RefRef{subsubsec}{ConstDefs}}
	\end{Table}}
\end{Initializer}
...
\begin{Method}{\it{bool} __is_candidate_dir(dir)}
	...
	\begin{itemize}
	  ...
	  \item	ディレクトリ名が\tt{Template}または\tt{log}である。
...
\begin{Method}{\it{string} __runtime_addpath(ctl, platform)}
    ...
    \end{Brief}
\end{Method}
\begin{Method}{__report(msg_l, msg_s, header, newline)\\
