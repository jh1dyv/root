...
\begin{Method}{\plAryR{array3}
    ...
    \end{Brief}
\end{Method}
\begin{Method}{flush(\plVar{fh}, \plVar{mark}, \plVar{size1}, \plVar{size2},
...
\begin{Method}{flush1(\plVar{fh}, \plVar{mark}, \plAryR{buff})}
    ...
    \end{Brief}
\end{Method}
\begin{Method}{(\plVar{min1}, \plVar{max1}, \plVar{min2}, \plVar{max2},
