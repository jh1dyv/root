...
%% some specific ones
%
\def\Cont{\ \ {\rm{\scriptsize{(\KLUDGE 次の行に続く)}}}}
...
\def\SolutionFile{\KLUDGE ソリューションファイル\raise1ex\hbox{{\tiny [*1]}}}
\def\ProjectFile{\KLUDGE プロジェクトファイル\raise1ex\hbox{{\tiny [*2]}}}
\def\cmake{\tt{cmake}}
\def\make{\tt{make}}
\def\SprLib{Springhead\KLUDGE ライブラリ}
\def\SprProj{Springhead\KLUDGE プロジェクト}
